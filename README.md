...
🚀 **Live Demo (FastAPI App):** [https://api-test-generator-n5sd.onrender.com/](https://api-test-generator-n5sd.onrender.com/)
...
- 📊 View all extracted API endpoints in a clean, interactive table
- 🤖 AI automatically generates **Positive, Negative & Boundary** test cases
- ⬇️ Download generated `.py` test files directly or package all as a `.zip` archive
...
└── project/                      ← All source code lives here
    ...
    ├── index.html                # Premium HTML frontend
    ...
    ├── AI_USAGE_NOTE.md          # AI usage report
    │
...
6. Copy or download individual test files, or download all generated files at once as a ZIP archive.
...
| HTML + Tailwind CSS | Premium frontend |
